...
import { Download, Languages, FileText, Sparkles } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Manage your next-intl translations with ease. Upload your source file and target translations to compare, edit, and export your localization files.
          </p>
        </div>
            ...
            <CardContent>
              <div className="space-y-4">
                {targetFiles.map((file) => (
                  <div key={file.language} className="p-4 bg-purple-500/10 border border-purple-500/30 rounded-lg">
                    <div className="flex items-center justify-between">
                      <div>
        ...
        {sourceFile && targetFiles.length > 0 && (
          <div className="text-center mb-8">
            ...
            >
              {isProcessing ? 'Processing...' : 'Process Translations'}
            </Button>
          </div>
        )}
        ...
        {translations.length > 0 && (
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Badge variant="secondary" className="bg-gray-800 text-gray-300 px-4 py-2 text-sm">
              ...
              {getMissingCount() > 0 && (
                <Badge variant="destructive" className="bg-red-500/20 text-red-300 border-red-500/30 px-4 py-2 text-sm">
                  {getMissingCount()} missing translations
                </Badge>
              )}
            </div>
